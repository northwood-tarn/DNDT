...
- [ ] The base terrain was generated from `0_plateau_assault.base_terrain_prompt.txt`.
- [ ] The base terrain contains no placed items from `0_plateau_assault.placed_items.json`.
...
- [ ] Every placed item in `0_plateau_assault.placed_items.json` has a generated asset or an explicit reuse decision.
...
- [ ] Cover objects exist only where `0_plateau_assault.placed_items.json` says cover exists.
- [ ] Feature objects exist only where `0_plateau_assault.placed_items.json` says features exist.
- [ ] Light sources exist only where `0_plateau_assault.placed_items.json` or `0_plateau_assault.grid.json` allows them.
- [ ] NPC/neutral actor assets exist only where authored.

## Composite

- [ ] The composite was assembled from `0_plateau_assault.composition.json`.
- [ ] Placed assets use the listed final-map anchor pixels, source-image local anchors, registered footprint bounds, and z order.
- [ ] Every visible tactical object matches `0_plateau_assault.grid.json` and `0_plateau_assault.placed_items.json`.
