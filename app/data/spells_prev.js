...
export function listSpellsByClass(cls) {
  ...
  circle_of_death: {
    ...
    classes: ["Warlock","Wizard","Sorcerer"],
    source: "PHB",
    tags: ["damage","area","necrotic"],
    text: "A 60‑ft radius necrotic wave. CON save for 8d6 necrotic damage (half on success).",
    dialogueRelated: false,
    hooks: { save: { ability: "CON", dcFrom: "spellSaveDC", onSave: "half" }, damage: { dice: "8d6", type: "necrotic", addMod: false, perDart: false } }
  },
  ...
  investiture_of_the_patron: {
    ...
    classes: ["Warlock"],
    source: "Homebrew",
    tags: ["self_buff","aura","concentration","form_choice"],
  ...
  mental_prison: {
    ...
    source: "XGtE",
    tags: ["control","psychic","concentration"],
  ...
  disintegrate: {
    ...
    source: "PHB",
    tags: ["damage","single_target","force"],
    ...
    dialogueRelated: false,
    hooks: { save: { ability: "DEX", dcFrom: "spellSaveDC", onSave: "negates" }, damage: { dice: "10d6+40", type: "force", addMod: false, perDart: false } }
  },
