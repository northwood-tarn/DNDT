export const conditions = [
  ...
  },
  {
    ...
    name: "Confused",
    category: "combat_special",
    summary: "Cannot take reactions and struggles to act coherently.",
    mechanics: {
  ...
  },
  {
    ...
    name: "Fire Shield",
    category: "combat_special",
    summary: "Punishes creatures that strike the warded target in melee.",
    mechanics: {},
    effects: ["A melee attacker takes the shield's retaliation damage."],
  },
  {
    id: "investiture_of_the_patron",
    name: "Investiture of the Patron",
    category: "combat_special",
    summary: "The caster is transformed by their permanently chosen patron form.",
    mechanics: {},
    effects: ["Grants the selected patron form and its repeatable attack."],
  },
  {
    id: "regenerating",
    name: "Regenerating",
    category: "combat_special",
    summary: "Regains hit points at the start of each turn.",
    mechanics: {},
    effects: ["Regains hit points at the start of each turn."],
  },
  {
    id: "deafened",
    name: "Deafened",
