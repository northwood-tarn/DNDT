...
const PORTRAIT_ASSETS = {
  ...
  subclass: {
    the_lantern: "assets/portraits/lantern-pact-negative-ink.png",
  },
};
...
function isResolverChoiceRequirement(requirement) {
  return ["skill", "origin_feat_choice", "origin_feat", "tool", "spell", "class", "weapon", "ability_score", "saving_throw_ability", "skill_expertise", "skill_or_tool", "damage_type"].includes(requirement.kind) &&
