...
const STARTER_CHARACTER_VARIANT_SPECS = {
  ...
  wizard: {
    ...
    steps: [
      ...
      { type: "gear", value: { weaponIds: ["quarterstaff"], armorId: null, shieldId: null, inventory: [{ id: "healing_potion", quantity: 1 }], attunedItemIds: [] } },
  ...
  warlock: {
    ...
    steps: [
      ...
      { type: "gear", value: { weaponIds: ["quarterstaff"], armorId: "leather", shieldId: null, inventory: [{ id: "healing_potion", quantity: 1 }], attunedItemIds: [] } },
  ...
  cleric: {
    ...
    steps: [
      ...
      { type: "gear", value: { weaponIds: ["quarterstaff"], armorId: "half_plate", shieldId: "shield", inventory: [{ id: "healing_potion", quantity: 2 }], attunedItemIds: [] } },
