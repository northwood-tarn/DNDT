...
export function createActorDefinition(input = {}) {
  return {
    ...
    presentation: {
      ...
      miniatureBaseId: input.presentation?.miniatureBaseId || null,
      miniatureBaseAsset: input.presentation?.miniatureBaseAsset || null,
    },
...
export function resolveActorToCombatActor(definitionInput, instanceInput, options = {}) {
  ...
  const actor = {
    ...
    portraitId: definition.presentation.portraitId || base.portraitId || null,
    miniatureId: definition.presentation.miniatureId || base.miniatureId || null,
    miniatureBaseId: definition.presentation.miniatureBaseId || base.miniatureBaseId || null,
    miniatureBaseAsset: definition.presentation.miniatureBaseAsset || base.miniatureBaseAsset || null,
