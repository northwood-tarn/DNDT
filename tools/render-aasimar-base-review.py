...
FIGURES = (
    LIB / "aasimar_feminine_01/cutout/aasimar_feminine_01.png",
    LIB / "aasimar_masculine_01/cutout/aasimar_masculine_01.png",
)
OUT = LIB / "aasimar/review/aasimar_stance_1_coin_check_100pct.png"
...
def main():
    ...
    for i, path in enumerate(FIGURES):
        panel = i * 900
        canvas.alpha_composite(base, (panel + 200, 770))
        figure = fitted(path)
        canvas.alpha_composite(figure, (panel + 450 - feet_midpoint(figure), 239))
