...
const VALID_EFFECT_KEYS = new Set(["resources", "expertise", "proficiencies", "actionOptions", "choiceRequirements", "modifiers", "auras", "triggeredEffects", "reactions", "damageRiders", "conditionRiders", "modifierRiders", "healingRiders", "resistances", "spells", "narrativeTags", "narrativeOnly", "advancement", "attackAction", "weaponMastery"]);
